...
# Script to create default tile resources
# Run this from the editor to generate basic tiles

func _run():
	print("Creating default tile resources...")
	...
	print("Default tiles created successfully!")
