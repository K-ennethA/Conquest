...
func _ready():
	...
	print("  - Click 'Details' (or press D) to open the unit's full page")
	print("  - The left card shows live HP, effective stats and statuses at a glance")
	print("  - Keyboard shortcuts: M (Move), E (End Turn), D (Details), C (Cancel)")
	print("")
